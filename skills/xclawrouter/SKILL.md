...
Smart LLM router that saves <!-- br:savings.autoVsBaselinePct -->84<!-- /br:savings.autoVsBaselinePct -->% on inference costs by routing each request to the cheapest model that can handle it. <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models across 9 providers (<!-- br:models.free -->6<!-- /br:models.free --> free models), all through one wallet.
