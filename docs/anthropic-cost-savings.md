...
[ClawRouter](https://github.com/BlockRunAI/XClawRouter) is an open-source local proxy that sits between your app and <!-- br:models.chatVisible -->71<!-- /br:models.chatVisible --> AI models. It saves you money in three ways: **smart routing**, **token optimization**, and **response caching**.
...
- [ClawRouter on GitHub](https://github.com/BlockRunAI/XClawRouter) — MIT License
