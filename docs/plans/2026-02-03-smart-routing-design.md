...
Phase 1 solved API key management (one wallet for <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> models). Phase 2 solves cost optimization by routing queries to the cheapest capable model.
