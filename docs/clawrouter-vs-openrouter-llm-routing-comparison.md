...
XClawRouter maintains a curated catalog of <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models across 9 providers (including 11 free models), updated with each release. Delisted models have automatic redirect aliases:
