...
When you route AI requests across <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models from 8 providers, you can't just pick the cheapest one. You can't just pick the fastest one either. We learned this the hard way.
...
Before building the router, we needed ground truth. We benchmarked all <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models through our production payment pipeline.
...
Raw data (<!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models, latency, throughput, IQ scores, pricing): [`benchmark-merged.json`](https://github.com/BlockRunAI/XClawRouter/blob/main/benchmark-merged.json)
...
_BlockRun is the x402 micropayment gateway for AI. One wallet, <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models, pay-per-request with USDC. [blockrun.ai](https://blockrun.ai)_
